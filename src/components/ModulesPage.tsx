...
const modules: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Estrutura idêntica ao mapa original",
    ],
  ...
  },
  {
    ...
    features: [
      "Registo detalhado de tempos de trabalho por colaborador",
      "Exclusão de horas extra não contabilizáveis",
  ...
  },
  {
    ...
    features: [
      ...
      "Apoio à monitorização da assiduidade",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Base para auditorias e validações",
    ],
    demoImage: "https://i.imgur.com/Bh64ykm.png",
    demoVideo: "https://youtu.be/2d25bmxjZ7M",
    detailedDescription:
  ...
  },
  {
    ...
    features: [
      ...
      "Segmentação por equipa, departamento",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Eliminação de redundância e erros humanos",
    ],
